...
Tags: stripe, automatorwp, simple, pay, payment
...
Connect AutomatorWP with WP Simple Pay
...
[WP Simple Pay](https://wordpress.org/plugins/stripe/ "WP Simple Pay") is the best Stripe payments plugin for WordPress that lets you start accepting one-time and recurring payments without setting up a shopping cart.

This plugin automatically connects [AutomatorWP](https://wordpress.org/plugins/automatorwp/ "AutomatorWP") with WP Simple Pay adding new triggers that you can use to connect with other plugins and automate workflows letting you save time and get focused on your most important work.

= Triggers =

* User completes a purchase through any/specific form.

**Note:** Triggers from this add-on works on WP Simple Pay Lite and Pro versions.

= Pro version =

[Pro version](https://automatorwp.com/add-ons/wp-simple-pay/ "AutomatorWP - WP Simple Pay") available that let's you expand the integration between AutomatorWP and WP Simple Pay bringing you more ways to automatize your website payments.
